...
export default function Sidebar() {
  const navItems = [
    { icon: FiUser, label: "Farmer", to: "farmer" },
    { icon: FiUser, label: "Manufacturer", to: "manufacturer" },
    { icon: FiUser, label: "Distributor", to: "distributor" },
    { icon: FiUser, label: "Retailer", to: "retailer" },
